...
function showAdminTab(tab) {
    ...
    document.getElementById('adminBroadcast').style.display = 'none';
    ...
    if (tab === 'items') {
        ...
        document.getElementById('adminBroadcast').style.display = 'block';
    } else if (tab === 'users') {
    ...
    try {
        ...
        if (response.ok) {
            ...
            if (settings.channel_link) {
                document.getElementById('channelSocialLink').href = settings.channel_link;
            }
            if (settings.chat_link) {
                document.getElementById('chatSocialLink').href = settings.chat_link;
            }
        }
    } catch (error) {
